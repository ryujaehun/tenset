...
NETWORK_INFO_FOLDER = '/root/scripts/dataset/network_info'
TO_MEASURE_PROGRAM_FOLDER = '/root/scripts/dataset/to_measure_programs'
MEASURE_RECORD_FOLDER = '/root/scripts/dataset/measure_records'
