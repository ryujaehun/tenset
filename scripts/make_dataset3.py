...
if __name__ == "__main__":
    ...
    parser.add_argument("--target", nargs="+", type=str, default=['llvm  -mtriple=aarch64-linux-gnu -mattr=+neon,+v8.2a,+dotprod -model=graviton2'])#["llvm -model=epyc-7452"])
    ...
    parser.add_argument("--hold-out", type=str, default='resnet-50', choices=['resnet-50', 'all_five'])
